		...
		if len(deger) == 1 and deger == "0":
			...
			try:
				...
				if basamak == 1:
					...
					sonuc = "{} {}".format(ONLAR[dizi[1]],
					BIRLER[dizi[0]])
				elif basamak == 3:
					sonuc = "{} {} {}".format(YUZLER[dizi[2]],
					ONLAR[dizi[1]],
					BIRLER[dizi[0]])
				elif basamak == 4:
					sonuc = "{} {} {} {}".format(BINLER[dizi[3]],
					YUZLER[dizi[2]],
					ONLAR[dizi[1]],
					BIRLER[dizi[0]])
				elif basamak == 5:
					if dizi[3] == "0":
						sonuc = "{} {} {} {}".format(ONLAR[dizi[4]]+" Bin",
						YUZLER[dizi[2]],
						ONLAR[dizi[1]],
						BIRLER[dizi[0]])
					else:
						sonuc = "{} {} {} {} {}".format(ONLAR[dizi[4]],
						BIRLER[dizi[3]]+" Bin",
						YUZLER[dizi[2]],
						ONLAR[dizi[1]],
						BIRLER[dizi[0]])
