class Sayi2Metin:
    ...
    def cevir(self, sayi):
        ...
        try:
            ...
            dizi.reverse()
            basamak = len(dizi)
            if basamak == 1:sonuc = "{}".format(BIRLER[dizi[0]])
            elif basamak == 2:sonuc = "{} {}".format(ONLAR[dizi[1]], BIRLER[dizi[0]])
            elif basamak == 3:sonuc = "{} {} {}".format(YUZLER[dizi[2]], ONLAR[dizi[1]], BIRLER[dizi[0]])
            elif basamak == 4:sonuc = "{} {} {} {}".format(BINLER[dizi[3]], YUZLER[dizi[2]], ONLAR[dizi[1]], BIRLER[dizi[0]])
            elif basamak == 5:
                if dizi[3] == "0":
